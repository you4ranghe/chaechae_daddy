    ...
    <div className="rounded-xl border border-gray-200 bg-white p-6">
      ...
      {connection ? (
        <div className="mt-4 space-y-3">
          ...
          <div className="flex gap-2 pt-2">
            <button
              ...
              onClick={handleSync}
              disabled={syncing}
              className="flex-1 rounded-lg bg-pink-600 px-4 py-2 text-sm font-medium text-white hover:bg-pink-500 disabled:opacity-50"
            >
        ...
        <a
          ...
          className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-rose-600 to-pink-600 px-4 py-2.5 text-sm font-semibold text-white hover:opacity-90"
        >
