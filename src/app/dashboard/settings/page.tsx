...
export default async function SettingsPage({ searchParams }: SettingsPageProps) {
  ...
  return (
    <div className="space-y-6 animate-fade-up">
      {/* 헤더 */}
      <section className="bezel relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-pink-50 px-6 py-7 sm:px-8">
        <span aria-hidden className="pointer-events-none absolute -right-10 -top-10 h-40 w-40 rounded-full bg-gray-200/40 blur-[60px] animate-glow" />
        ...
        <div className="relative flex items-start gap-3.5">
          <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-gray-700 to-gray-900 shadow-[0_4px_14px_-2px_rgb(17_24_39_/_0.4)]">
          ...
          <div className="min-w-0">
            <p className="text-[10px] font-bold uppercase tracking-[0.16em] text-gray-500">Settings</p>
            <h1 className="mt-0.5 text-[22px] font-black tracking-tight text-gray-900">설정</h1>
