      ...
      <section className="bezel relative overflow-hidden bg-gradient-to-br from-emerald-50 via-white to-teal-50 px-6 py-7 sm:px-8">
        ...
        <div className="relative flex items-start gap-3.5">
          ...
          <div className="min-w-0">
            <p className="text-[10px] font-bold uppercase tracking-[0.16em] text-emerald-600">Analytics Agent</p>
            <h1 className="mt-0.5 text-[22px] font-black tracking-tight text-gray-900">성과 분석</h1>
